...
class YogurtnetprDataset(BaseDataset):
    """
    ...
    def modify_commandline_options(parser, is_train):
        ...
        parser.set_defaults(input_nc = 4, output_nc = 2, direction='AtoB', gpu_ids = '0,1')
        return parser
    ...
    def __getitem__(self, index):
        ...
        A = np.dstack((A1test, A2test, A[:,:,6], A3test))

        A_index = [0, 1, 2, 3]
        A_max = [5e-09, 480, 390, (300+300)]
        A_min = [0, 0, 0, 0]
        ...
        #A, _ = self.filting_matrix(A, 5)   #滤波处理
